    ...
    <div>
        <x-filament::card class="p-4 bg-white dark:bg-gray-900 text-black dark:text-white">
            ...
            <table
                ...
                <thead>
                    <tr>
                        <th class="border border-black dark:border-gray-300 p-2 w-1/12 bg-white dark:bg-gray-800">NO.
                        </th>
                        <th class="border border-black dark:border-gray-300 p-2 w-5/12 bg-white dark:bg-gray-800">
                            DESKRIPSI BARANG</th>
                        <th class="border border-black dark:border-gray-300 p-2 w-2/12 bg-white dark:bg-gray-800">QTY
                        </th>
