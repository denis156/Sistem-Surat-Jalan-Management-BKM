...
class ViewDeliveryNote extends Page
{
    ...
    protected static string $view = 'filament.warehouse.resources.delivery-note-resource.pages.view-delivery-note';
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Actions\Action::make('edit')
                ...
                ->visible(fn() => $this->record && $this->record->status === 'sampai'),
        ];
    }
